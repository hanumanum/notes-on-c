...
C լեզվի `return` հրամանը ֆունկցիայից արժեք վերադարձնող գործողությունն է։ Յուրաքանչյուր ֆունկցիա պարտավոր է ունենալ գոնե մեկ `return` հրաման և այդ հրամանի արգումենտն էլ հենց ֆունկցիայի արժեքն է։ (Բացառությամբ այն դեպքերի, երբ ֆունկցիայի վերադարձրած արժեքի տիպը `void` է։)
