...
Այստեղ `double`, `float`, `int`, `char` և `long` բառերը *ծառայողական բառեր* են, իսկ `a`, `b`, `c`, `d0`, `d1`, `sym` և `e1a` բառերը՝ իդենտիֆիկատորներ։ C լեզվի *իդենտիֆիկատորը* տառով կամ ընդգծման նիշով՝ «`_`», սկսվող տառերի ու թվանշանների հաջորդականություն է։ Պետք է հիշել նաև, որ C լեզվում մեծատառերն ու փոքրատառերը տարբերվում են․ `abc0` և `aBc0` բառերը տարբեր իդենտիֆիկատորներ են։ 
...
Հայտարարության արդյունքում փոփոխականին հատկացված հիշողության բայթերից առաջինի համարը կոչվում է փոփոխականի *հասցե*։ Փոփոխականի հասցեն վերադարձնում է `&` միտեղանի (unary) գործողությունը։ Օրինակ, `&pi` արտհայտության արժեքը `pi` փոփոխականի հասցեն է։
