...
Եթե `prog01` կատարվող ֆայլն աշխատեցնելուց հետո bash-ի `echo` հրամանով արտածենք `$?` փոևդոփոփոխականը, որը Linux համակարգերում պարունակում է վերջին աշխատած ծրագիր ավարտի կոդը, ապա կստանանք `0` արժեքը։ Այս `0`-ն հենց իմ ծրագրի `main` ֆունկցիայից `return` հրամանով վերադարձրած արժեքն է։
